...
echo 'CONFIG_PACKAGE_luci-app-mosquito=y' >> $BUILDROOT/.config
...
echo 'CONFIG_PACKAGE_luci-proto-relay=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_luci-proto-wireguard=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_luci-theme-bootstrap=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_mesh11sd=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_mosquitto-ssl=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_mosquitto-client-ssl=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_libmosquitto-ssl=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_parted=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_px5g-mbedtls=y' >> $BUILDROOT/.config
echo 'CONFIG_PACKAGE_relayd=y' >> $BUILDROOT/.config
